...
*/
define('API_KEY_CR', 'توکن ربات اصلی');
define('API_KEY_LOCK_BOT', API_KEY_CR);
##----------------------
$host_folder = 'https://joopir.shop/TGbots/BuildYourMessenger'; //ادرس فولدر سورس
$admin = 795455605; // ایدی عددی ادمین
$support = '@JoopirBot'; // پشتیبانی
$main_channel = '@BuildYourMessenger'; // یوزرنیم کانال
$main_bot = '@BuildYourMessengerBot'; // یوزرنیم ربات
$logchannel = '-1001375535579'; // ایدی کانال برای ارسال لاگ
...
$lock_channel_2 = '@JangeQabayel'; // کانال دوم قفل
...
##----------------------اطلاعات دیتابیس
$DB_HOST = 'localhost';
$DB_NAME = 'joopirvxbuild';
$DB_USERNAME = 'vxcvxcv';
$DB_PASSWORD = 'ABCDSzcx5vgvbn41dsd';
##----------------------
